			...
			<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
				<form method="post" action="insertMahasiswaController.php">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" placeholder="nama departemen lengkap" name="departemen">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="number" class="form-control" placeholder="tahun masuk" name="angkatan">
					</div>
